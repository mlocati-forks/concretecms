...
var ccmi18n_filemanager = ' . json_encode([
    ...
    'moreFoldersFound' => t('More folders found. Refine your search.'),
    'name' => t('Name'),
    'newFolderName' => t('New folder name'),
    'pending' => t('Pending'),
    ...
    'rescan' => t('Rescan'),
    'search' => t('Search'),
    'searchFolders' => t('Search Folders'),
